      ...
      <div className="flex-1 flex items-center justify-center p-8 md:p-12 lg:p-20 bg-white overflow-y-auto">
        <div className="w-full max-w-md my-auto py-12">
          ...
          <header className="mb-12">
            <h1 className="text-4xl font-bold text-slate-900 tracking-tight mb-3 leading-tight">Sign in to your account</h1>
          ...
          <form action={formAction} className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between ml-1">
                ...
                <Link href="/forgot-password" className="text-xs font-bold text-purple-600 hover:text-purple-500 transition-colors">Forgot your password?</Link>
              </div>
              <div className="relative group">
          ...
          <div className="mt-12">
            <div className="relative mb-8 text-center">
              ...
              <span className="relative px-6 bg-white text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Or continue with</span>
            </div>
          ...
          <footer className="mt-12 text-center text-slate-500 font-medium text-sm">
            Don't have an account? <Link href="/signup" className="text-purple-600 font-bold hover:text-purple-400 decoration-purple-600/20 underline-offset-4 hover:underline">Sign up</Link>
          </footer>
        </div>
      </div>
    </div>
